...
var ReviewAssistanceController = function($scope, $rootScope) {
...
ReviewAssistanceController.$inject = ['$scope', '$rootScope'];

require('./_module').controller('ReviewAssistanceController', ReviewAssistanceController);
