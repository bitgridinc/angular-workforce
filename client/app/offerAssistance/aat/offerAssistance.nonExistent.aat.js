...
describe('trying to assist a non-existent beacon', function() {
  ...
  beforeEach(function() {
    ...
    ptor.get('/#/dashboard/mycompany/detail/99999non-exis-tent-9999-999999999999/assist');
  });
  ...
  it('should display an error page', function() {
    expect(browser.getCurrentUrl()).toContain('/#/dashboard/mycompany/detail/99999non-exis-tent-9999-999999999999/assist');
